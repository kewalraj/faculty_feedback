...
$attendance = $users['attendance']; // Changed from CGPA to Attendance
?>
    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
          ...
          <?php if ($attendance >= 75) : ?> <!-- Assuming 75% is the threshold -->
            <li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-thumbs-down"></span> Feedback</a></li>
          <?php else : ?>
            <li><a href="i" onclick="alert('You are not eligible to give feedback because your attendace is LOW'); return false;">
                <span class="glyphicon glyphicon-thumbs-down"></span> Feedback</a></li>
          <?php endif; ?>
        ...
        ?>
          ...
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                <th>Programme</th>
                <td><?php echo $users['programme']; ?></td>
              </tr>
              <tr>
                <th>Semester</th>
              ...
              <tr>
                <th>Attendance (%)</th> <!-- Changed label -->
                <td><?php echo $users['attendance']; ?></td> <!-- Fetching attendance -->
              </tr>

              <tr>
                <th>Date of Birth</th>
                <td><?php echo date('d-m-Y', strtotime($users['dob'])); ?></td>
              </tr>
