                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li><a href="dashboard.php?info=assign_subject"><i class="fa fa-book"></i> Assign Subject</a></li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="dashboard.php?info=add_subject"><i class="fa fa-plus"></i> Add Subject</a></li>
                            </ul>
                        </li>
